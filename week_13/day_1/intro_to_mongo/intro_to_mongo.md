...
Once connected to a MongoDB database, how do we reference it when we want to intteract with it?
<details>
<summary>Answer</summary>
`db`
</details>
...
Databases allows us to organise collections of data and access data efficiently. Non-relational data is data that doesn't fit easily into a relational schema, with tables of columns. If your data model is non-relational, you may decide to use a non-relational database, such as MongoDB, which stores data as JSON documents in collections. To query a MongoDB we use with JavaScript.
